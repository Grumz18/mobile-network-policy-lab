...
The next eligible work is to execute CP-035 only.
...
The next step is to execute CP-035 only.
...
Execute CP-035 only to run the bounded launch-verification probe after successful CP-034 install verification, without entering runtime debugging, interaction testing, or feature work.
...
Continuity will degrade if future work skips CP-035 execution and jumps directly into runtime debugging, interaction testing, or broad `assemble*` work.
...
If future work starts Android product implementation, per-app routing, transport logic, or broad build repair before CP-035 is executed and captured under a bounded checkpoint, continuity and checkpoint discipline will degrade.
