...
The next eligible work is to execute CP-046 only in bounded scope to verify minimal ADB shell transport stability after persistent CP-045 transport errors.
...
- CP-046 result: `pending` (authoring only; execution not yet run)
...
- CP-046 execution artifact and evidence (`docs/android/ANDROID_ADB_SHELL_TRANSPORT_STABILITY.md` plus CP-046 run logs)
...
Execute CP-046 only in bounded scope to verify minimal ADB shell transport stability with single-probe discipline and first-outcome stop rule.
