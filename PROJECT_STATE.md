...
- Android build-ready local workstation/toolchain state
- Materialized external local source dependencies required by `libcore` (`libneko`, `sing-box`)
...
If future work starts Android product implementation, per-app routing, transport logic, or ad hoc toolchain repair before CP-009 is defined, continuity and checkpoint discipline will degrade.
