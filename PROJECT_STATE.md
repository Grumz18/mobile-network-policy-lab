...
CP-040 execution is currently blocked by adb device-state drift (`adb devices -l` returned zero online targets), so resumed-task verification has not yet been entered.
